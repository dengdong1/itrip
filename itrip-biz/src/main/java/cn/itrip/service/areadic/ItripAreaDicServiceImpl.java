...
public class ItripAreaDicServiceImpl implements ItripAreaDicService {
    ...
    @Override
    public List<ItripAreaDic> querytradearea(Map<String, Object> param) throws Exception {
        return itripAreaDicMapper.getItripAreaDicListByMap(param);
    }

    @Override
    public ItripHotel getItripMapHotelId(Integer id) {
        return itripAreaDicMapper.getItripMapHotelIds(id);
    }
    @Override
    public ItripHotel getItripMapHotelIdstwo(Long id) {
        return itripAreaDicMapper.getItripMapHotelIdstwo(id);
    }
