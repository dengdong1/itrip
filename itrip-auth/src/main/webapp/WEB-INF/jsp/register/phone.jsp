...
<script type="text/javascript">
    $(function () {
        $("#div_register input[name='userCode']").blur(function () {
            ...
            $.ajax({
                "url": "${pageContext.request.contextPath}/webapps/ckusr",
                "type": "GET",
                "data": {"name": userCode},
                "dataType": "json",
        ...
        $("#tijiao").click(function () {
            ...
            $.ajax({
                "url": "${pageContext.request.contextPath}/webapps/doregister",
                "type": "POST",
                "data": arrs,
        ...
        $("#activateTijiao").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/webapps/activate?user=" + user + "&code=" + code;
            $.ajax({
                "url": url,
                "type": "PUT",
                "dataType": "json",
